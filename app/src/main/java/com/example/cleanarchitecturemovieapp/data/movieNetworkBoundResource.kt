package com.example.cleanarchitecturemovieapp.data

import com.example.cleanarchitecturemovieapp.data.source.remote.network.MovieApiResponse
...
inline fun <ResultType, RequestType> movieNetworkBoundResource(
